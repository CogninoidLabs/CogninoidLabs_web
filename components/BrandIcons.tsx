...
export function GithubIcon({ className, strokeWidth: _sw, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export function LinkedinIcon({ className, strokeWidth: _sw, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export function TwitterIcon({ className, strokeWidth: _sw, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
