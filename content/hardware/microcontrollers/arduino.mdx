...
<ComponentDiagram
  component="arduino"
  title="Arduino Uno R3 — Board Diagram"
  caption="Digital I/O pins 0–13 along the top edge (~ marks indicate PWM-capable pins). Analog inputs A0–A5 and power rail along the bottom. ATmega328P microcontroller in the centre. USB Type-B port for programming and serial communication."
/>

## Important parameters (Arduino Uno R3)

<SpecTable title="Arduino Uno R3 Specifications">
  <SpecRow parameter="Microcontroller" value="ATmega328P" notes="8-bit AVR" />
  <SpecRow parameter="Operating voltage" value="5V" notes="Regulated" />
  <SpecRow parameter="Digital I/O pins" value="14" notes="6 with PWM output" />
  <SpecRow parameter="Analogue input pins" value="6" notes="10-bit resolution" />
  <SpecRow parameter="Flash memory" value="32 KB" notes="0.5 KB used by bootloader" />
  <SpecRow parameter="SRAM" value="2 KB" notes="Runtime memory" />
  <SpecRow parameter="Clock speed" value="16 MHz" notes="Crystal oscillator" />
  <SpecRow parameter="USB connection" value="Type B" notes="For programming and serial" />
  <SpecRow parameter="DC current per I/O pin" value="40 mA" notes="Max — use resistors with LEDs" />
</SpecTable>

## Pinout overview

<PinoutBox title="Arduino Uno Key Pins">
  <PinRow pin="5V" label="5V" type="power" description="5V regulated output — powers sensors" />
  <PinRow pin="3.3V" label="3.3V" type="power" description="3.3V output — 50 mA max" />
  <PinRow pin="GND" label="GND" type="ground" description="Ground reference — multiple pins available" />
  <PinRow pin="0" label="RX" type="communication" description="Serial receive — used for USB programming" />
  <PinRow pin="1" label="TX" type="communication" description="Serial transmit" />
  <PinRow pin="2–13" label="D2–D13" type="digital" description="Digital input/output — HIGH or LOW" />
  <PinRow pin="3,5,6,9,10,11" label="PWM" type="analog" description="PWM output — analogWrite() for motors, LEDs" />
  <PinRow pin="A0–A5" label="A0–A5" type="analog" description="Analogue input — reads 0–5V as 0–1023" />
  <PinRow pin="A4" label="SDA" type="communication" description="I2C data" />
  <PinRow pin="A5" label="SCL" type="communication" description="I2C clock" />
</PinoutBox>
...
<NextStepBox>
  <NextStep href="/hardware/esp32" label="ESP32" description="More powerful microcontroller with Wi-Fi and Bluetooth" />
  <NextStep href="/hardware/servo-motor" label="Servo Motor" description="The actuator you will control with Arduino" />
  <NextStep href="/hardware/motor-driver" label="Motor Driver" description="How to drive DC motors safely" />
</NextStepBox>
