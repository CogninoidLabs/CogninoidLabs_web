...
<NextStepBox>
  <NextStep href="/workflows/04-connect-domain" label="Connect a domain to Vercel" description="Use your custom domain" />
  <NextStep href="/workflows/05-search-console-sitemap" label="Add Google Search Console and sitemap" description="Make your site findable on Google" />
</NextStepBox>
