...
<NextStepBox steps={[
  { label: "Push a project to GitHub", href: "/workflows/02-push-to-github", description: "Deeper Git workflow" },
  { label: "Deploy GitHub repo to Vercel", href: "/workflows/03-deploy-to-vercel", description: "Full deployment configuration" },
  { label: "Debug AI-generated code", href: "/workflows/07-debug-ai-code", description: "When things go wrong" }
]} />
