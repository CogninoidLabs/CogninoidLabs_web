...
<NextStepBox steps={[
  { label: "What is GitHub?", href: "/start-here/what-is-github", description: "Learn how to track and share your code" },
  { label: "Build your first AI-assisted website", href: "/workflows/01-first-ai-website", description: "Put VS Code to use immediately" }
]} />
