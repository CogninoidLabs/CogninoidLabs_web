...
<NextStepBox>
  <NextStep href="/start-here/what-is-vibe-coding" label="What is vibe coding?" description="The approach to avoid" />
  <NextStep href="/start-here/what-is-verifiable-building" label="What is verifiable building?" description="The approach to develop" />
  <NextStep href="/workflows/08-review-agent-changes" label="Review AI-agent changes before commit" description="The workflow that protects your codebase" />
</NextStepBox>
