...
<NextStepBox steps={[
  { label: "Review AI-agent changes before commit", href: "/workflows/08-review-agent-changes", description: "The exact workflow" },
  { label: "Build your first AI-assisted website", href: "/workflows/01-first-ai-website", description: "Apply verifiable building from day one" }
]} />
