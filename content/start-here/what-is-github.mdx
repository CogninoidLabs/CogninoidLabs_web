...
<NextStepBox>
  <NextStep href="/start-here/what-is-vercel" label="What is Vercel?" description="Connect GitHub to automatic deployment" />
  <NextStep href="/workflows/02-push-to-github" label="Push a project to GitHub" description="Step-by-step workflow" />
</NextStepBox>
