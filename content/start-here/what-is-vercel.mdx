...
<NextStepBox steps={[
  { label: "Deploy GitHub repo to Vercel", href: "/workflows/03-deploy-to-vercel", description: "Full step-by-step workflow" },
  { label: "What is deployment?", href: "/start-here/what-is-deployment", description: "Understand what happens during a deploy" }
]} />
